...
<p align="center">
  <img src="images/PostXHR.png" width="350" title="Componentes del ejemplo">  
</p>
...
4) Función setMessageUsingDOM(message). Pone un mensaje en la pantalla dependiendo del valor de message. True el usuario existe, false no existe.
